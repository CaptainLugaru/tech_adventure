...
public class DynimiteitemRangedItemUsedProcedure extends TechAdventureModElements.ModElement {
	public DynimiteitemRangedItemUsedProcedure(TechAdventureModElements instance) {
		super(instance, 52);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if ((((entity instanceof LivingEntity) ? ((LivingEntity) entity).getHeldItemMainhand() : ItemStack.EMPTY)
				.getItem() == new ItemStack(DynimiteItem.block, (int) (1)).getItem())) {
			if (entity instanceof LivingEntity) {
				((LivingEntity) entity).swing(Hand.MAIN_HAND, true);
			}
			if (entity instanceof PlayerEntity) {
				ItemStack _stktoremove = new ItemStack(DynimiteItem.block, (int) (1));
