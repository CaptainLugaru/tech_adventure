...
public class FloatingblacksmithstructureStructure extends TechAdventureModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 250) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("tech_adventure", "floating_blacksmith_structure"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("floatingblacksmithstructure"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tech_adventure:floatingblacksmithstructure"),
					configuredFeature);
		}
	}
	@SubscribeEvent
