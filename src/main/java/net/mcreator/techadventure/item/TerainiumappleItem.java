...
public class TerainiumappleItem extends TechAdventureModElements.ModElement {
	@ObjectHolder("tech_adventure:terainiumapple")
	public static final Item block = null;
	public TerainiumappleItem(TechAdventureModElements instance) {
		super(instance, 63);
	}
	...
	public static class FoodItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			double z = entity.getPosZ();
			{
				...
				TerainiumappleFoodEatenProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
