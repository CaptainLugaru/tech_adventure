...
public class BackpackItem extends TechAdventureModElements.ModElement {
	@ObjectHolder("tech_adventure:backpack")
	public static final Item block = null;
	public BackpackItem(TechAdventureModElements instance) {
		super(instance, 28);
