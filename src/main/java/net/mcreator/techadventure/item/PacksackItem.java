...
import net.mcreator.techadventure.gui.PacksackguiGuiWindow;
import net.mcreator.techadventure.gui.PacksackguiGui;
...
public class PacksackItem extends TechAdventureModElements.ModElement {
	@ObjectHolder("tech_adventure:packsack")
	public static final Item block = null;
	public PacksackItem(TechAdventureModElements instance) {
		super(instance, 55);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof PacksackguiGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Pack sack");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new PacksackguiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
