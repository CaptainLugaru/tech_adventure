...
public class TerainiumThrowingKnifeitemItem extends TechAdventureModElements.ModElement {
	@ObjectHolder("tech_adventure:terainium_throwing_knifeitem")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletterainium_throwing_knifeitem").setRegistryName("entitybulletterainium_throwing_knifeitem");
	public TerainiumThrowingKnifeitemItem(TechAdventureModElements instance) {
		super(instance, 59);
		FMLJavaModLoadingContext.get().getModEventBus().register(new TerainiumThrowingKnifeitemRenderer.ModelRegisterHandler());
	}
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					...
					if (entity.abilities.isCreativeMode || stack != ItemStack.EMPTY) {
						ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 6, 2);
						...
						}
						{
							...
							TerainiumThrowingKnifeitemRangedItemUsedProcedure.executeProcedure($_dependencies);
						}
					}
				}
			}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public void onCollideWithPlayer(PlayerEntity entity) {
			...
			World world = this.world;
			{
				...
				TerainiumThrowingKnifeitemBulletHitsLivingEntityProcedure.executeProcedure($_dependencies);
			}
		}
