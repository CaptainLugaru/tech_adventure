...
import net.mcreator.techadventure.procedures.AgentsmithminoinEntityIsHurt1Procedure;
import net.mcreator.techadventure.entity.renderer.AgentsmithminoinRenderer;
...
public class AgentsmithminoinEntity extends TechAdventureModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("agentsmithminoin").setRegistryName("agentsmithminoin");
	public AgentsmithminoinEntity(TechAdventureModElements instance) {
		super(instance, 139);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AgentsmithminoinRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -13421773, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("agentsmithminoin_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				AgentsmithminoinEntityIsHurt1Procedure.executeProcedure($_dependencies);
			}
