...
import net.mcreator.techadventure.entity.renderer.AncientMerchantRenderer;
import net.mcreator.techadventure.TechAdventureModElements;

@TechAdventureModElements.ModElement.Tag
public class AncientMerchantEntity extends TechAdventureModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("ancient_merchant").setRegistryName("ancient_merchant");
	public AncientMerchantEntity(TechAdventureModElements instance) {
		super(instance, 160);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AncientMerchantRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777012, -14811136, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("ancient_merchant_spawn_egg"));
	}
