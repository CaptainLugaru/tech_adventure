...
import net.mcreator.techadventure.procedures.AgentsmithEntityIsHurtProcedure;
import net.mcreator.techadventure.entity.renderer.AgentsmithRenderer;
...
public class AgentsmithEntity extends TechAdventureModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("agentsmith").setRegistryName("agentsmith");
	public AgentsmithEntity(TechAdventureModElements instance) {
		super(instance, 138);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AgentsmithRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -13421773, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("agentsmith_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.targetSelector.addGoal(1, new NearestAttackableTargetGoal(this, WizardEntity.CustomEntity.class, false, false));
		...
		public boolean attackEntityFrom(DamageSource source, float amount) {
			...
			Entity sourceentity = source.getTrueSource();
			{
				...
				AgentsmithEntityIsHurtProcedure.executeProcedure($_dependencies);
			}
