...
public class ShadowgrassBlock extends TechAdventureModElements.ModElement {
	@ObjectHolder("tech_adventure:shadowgrass")
	public static final Block block = null;
	public ShadowgrassBlock(TechAdventureModElements instance) {
		super(instance, 152);
	}
