...
import net.mcreator.techadventure.item.AlienMushroomfoodItem;
...
public class AlienMushroomBlock extends TechAdventureModElements.ModElement {
	@ObjectHolder("tech_adventure:alien_mushroom")
	public static final Block block = null;
	public AlienMushroomBlock(TechAdventureModElements instance) {
		super(instance, 115);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tech_adventure:alien_mushroom"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(AlienMushroomfoodItem.block));
		}
