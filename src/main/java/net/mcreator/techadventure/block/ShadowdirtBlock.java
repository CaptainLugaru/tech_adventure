...
public class ShadowdirtBlock extends TechAdventureModElements.ModElement {
	@ObjectHolder("tech_adventure:shadowdirt")
	public static final Block block = null;
	public ShadowdirtBlock(TechAdventureModElements instance) {
		super(instance, 153);
	}
