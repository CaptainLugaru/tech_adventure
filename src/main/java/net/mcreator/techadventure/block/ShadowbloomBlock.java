...
public class ShadowbloomBlock extends TechAdventureModElements.ModElement {
	@ObjectHolder("tech_adventure:shadowbloom")
	public static final Block block = null;
	public ShadowbloomBlock(TechAdventureModElements instance) {
		super(instance, 158);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("shadowbloom"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("tech_adventure:shadowbloom"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
			...
			return (ground == ShadowgrassBlock.block);
		}
