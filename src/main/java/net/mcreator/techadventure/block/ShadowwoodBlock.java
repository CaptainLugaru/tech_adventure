...
public class ShadowwoodBlock extends TechAdventureModElements.ModElement {
	@ObjectHolder("tech_adventure:shadowwood")
	public static final Block block = null;
	public ShadowwoodBlock(TechAdventureModElements instance) {
		super(instance, 156);
	}
